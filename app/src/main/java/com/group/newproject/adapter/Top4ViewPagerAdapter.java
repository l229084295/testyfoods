 ...
 */
public class Top4ViewPagerAdapter extends PagerAdapter {

    private List<ImageView> views;
    private List<Home.ObjBean.Top4Bean> datas;
    private BitmapUtils bitmapUtils;
    public Top4ViewPagerAdapter(List<ImageView> views, Context contex, List<Home.ObjBean.Top4Bean> datas) {
        this.views = views;
        this.datas = datas;
